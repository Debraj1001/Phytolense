...
export async function fetchAppConfig() {
  try {
    ...
    return {
      ...
      download_url_android: 'https://github.com/Debraj1001/Phytolense/releases/download/v1.0.3/app-release.apk',
      download_url_github_release: 'https://github.com/Debraj1001/Phytolense/releases/tag/v1.0.3',
